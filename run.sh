...
case $1 in
    ...
    imdb0s)
        ./hinscan ./data/imdb/ 0.64 3 0 "1 1 0 0 1" homoGraph0s.txt 0;;
    imdb1s)
        ./hinscan ./data/imdb/ 0.64 3 1 "1 1 0 0 1" homoGraph1s.txt 0;;
    imdb0l)
        ./hinscan ./data/imdb/ 0.64 3 0 "1 1 0 2 2 3 0 0 1" homoGraph0l.txt 0;;
    imdb1l)
        ./hinscan ./data/imdb/ 0.64 3 1 "1 1 0 2 2 3 0 0 1" homoGraph1l.txt 0;;
    pubmed0s)
        ./hinscan ./data/PubMed/ 0.64 3 0 "3 5 0 2 3" homoGraph0s.txt 0;;
    pubmed1s)
        ./hinscan ./data/PubMed/ 0.64 3 1 "3 5 0 2 3" homoGraph1s.txt 0;;
    pubmed0l)
        ./hinscan ./data/PubMed/ 0.64 3 0 "3 5 0 0 1 3 0 2 3" homoGraph0l.txt 0;;
    pubmed1l)
