...
case $1 in
    ...
    pubmed0s)
        ./hinscan ./data/PubMed/ 0.51 2 0 "3 5 0 2 3" homoGraph0s.txt 1;;
    pubmed1s)
        ./hinscan ./data/PubMed/ 0.51 2 1 "3 5 0 2 3" homoGraph1s.txt 1;;
    pubmed0l)
    ...
    tmdb0s)
        ./hinscan ./data/tmdb/ 0.51 2 0 "0 0 1 1 0" homoGraph0s.txt 1;;
    tmdb1s)
        ./hinscan ./data/tmdb/ 0.51 2 1 "0 0 1 1 0" homoGraph1s.txt 1;;
    tmdb0l)
    ...
    dblp0s)
        ./hinscan ./data/dblp70w/ 0.72 4 0 "1 3 0 0 1" homoGraph0s.txt 1;;
    dblp1s)
        ./hinscan ./data/dblp70w/ 0.72 4 1 "1 3 0 0 1" homoGraph1s.txt 1;;
    dblp0l)
